...
Genuine gaps between what MAW workflows assume and Cursor's actual
...
Whether Cursor auto-applies `.github/instructions/*.instructions.md`
by file type the way GitHub Copilot does natively should be verified
against Cursor's own current documentation, not assumed — this
