...
How a MAW-based session with Cursor runs end to end. Mechanics
...
- Add [`system-prompt.md`](system-prompt.md)'s content to .cursorrules.
- Confirm Cursor can read `AGENTS.md`, `.github/instructions/`,
...
- Let Cursor follow the linked `workflows/*.md` process — plan,
