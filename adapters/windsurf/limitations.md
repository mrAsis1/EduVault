...
Genuine gaps between what MAW workflows assume and Windsurf's actual
...
Whether Windsurf auto-applies `.github/instructions/*.instructions.md`
by file type the way GitHub Copilot does natively should be verified
against Windsurf's own current documentation, not assumed — this
