# Windsurf: Example Prompts

Worked examples invoking existing MAW workflows through Windsurf
specifically — no new process, just Windsurf-specific phrasing that
