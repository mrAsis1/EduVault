...
How a MAW-based session with Windsurf runs end to end. Mechanics
...
- Add [`system-prompt.md`](system-prompt.md)'s content to .windsurfrules.
- Confirm Windsurf can read `AGENTS.md`, `.github/instructions/`,
...
- Let Windsurf follow the linked `workflows/*.md` process — plan,
