...
GEMINI.md is a static snapshot — it doesn't auto-sync with changes to
...
## Point Gemini at the specific `.github/prompts/*.md` file for the task
...
## Verify Gemini actually applies scoped instructions the way Copilot does

Not every tool auto-scopes `.github/instructions/*.instructions.md` by
file type the way GitHub Copilot does natively — confirm Gemini's
