...
Genuine gaps between what MAW workflows assume and Gemini's actual
...
Whether Gemini auto-applies `.github/instructions/*.instructions.md`
by file type the way GitHub Copilot does natively should be verified
against Gemini's own current documentation, not assumed — this
